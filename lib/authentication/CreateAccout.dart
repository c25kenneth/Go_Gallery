...
import 'package:go_gallery/visitor_screens/VisitorHome.dart';
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Begin an immersive museum experience",
                  style: GoogleFonts.dmSans(
                    textStyle: const TextStyle(
                      fontSize: 16,
                ...
                Center(
                  child: RichText(
                    text: TextSpan(children: [
                      TextSpan(
                        text: "Are you a museum? ",
                        style: GoogleFonts.aBeeZee(color: Colors.grey, fontSize: 17),
                      ),
                      TextSpan(
                          text: 'Contact Us',
